...
### Changed
- **Renamed Tool**: Formally renamed the CLI tool from `checktwp` to `checkwp` (including ASCII banner).
...
- **Environment Standard**: Standardized the environment variable to `CHECKWP_AI_KEY`.
